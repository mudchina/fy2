...
LONG
	...
	set("exits", ([ /* sizeof() == 1 */
  		"south" : "/u/taoguan/grassland2",
]));
        set("item_desc", ([
                "door": "铜钉的大门，门上有门环，你可以敲(knock)或是踢(break)门。\n",
                "门": "铜钉的大门，门上有门环，你可以敲(knock)或是踢(break)门。\n",
        ]) );
...
void wantopen(object me)
{
	...
	waiter = new("/u/taoguan/npc/waiter_taoist");
	message("vision", "\n吱的一声，门向里开了。\n", this_object());
...
void wantbreak(object me)
{
	...
	tao1 = new("/u/taoguan/npc/up_taoist");
	tao1->move(this_object());
	tao2 = new("/u/taoguan/npc/reg_taoist");
	tao2->move(this_object());
	tao3 = new("/u/taoguan/npc/reg_taoist");
