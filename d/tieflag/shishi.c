...
void create()
{
  set("short","石室");
  set("long",@LONG
石室形作八角，共有八门，门上重帘垂地，分作红、橙、黄、绿、
青、蓝、紫、黑八色。
暗色垂帘门前，有几具石榻玉几，放着些鲜果佳肴，香茶美酒，
翠杯玉盏，琳琅满目，美不胜收。
LONG
  );
  set("exits",([
...
{      
    object ob;
    if(ob=present("zhu zao", this_object()) && !me->query_temp("mark/sucarray"))
	{
		message_vision(BLU "朱藻说道：“没过我的七仙女阵是休想离开这里的。”\n" NOR,me);
                 return notify_fail("");
	}
    return 1;
}           
