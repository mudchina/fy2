...
void create()
{
        set("short", "草坪");
        set("long", @LONG
这是一片碧绿的草坪，踩上去觉得异常的柔软温厚，草坪一直延伸到小
河畔，青青草根也浸入河水之中。河面上点点烁金,波纹轻轻荡漾。草坪的
南面，一棵高大的梧桐树，枝干斜伸，两根古藤粗粗挽就一个秋千，每逢阳
光明媚的时候，安儿总会在这里要小狗娃推着她荡秋千，直至＂露浓花瘦，
薄汗轻衣透＂时才肯罢休。
LONG
        );
        set("exits", ([ 
	...
	set("item_desc", ([
	"qiu qian": "秋千系用古藤挽就，虽然简陋，却别有情趣。你可以试着荡荡看。 （ｓｗｉｎｇ）n",
	"秋千": "秋千系用古藤挽就，虽然简陋，却别有情趣。你可以试着荡荡看。 （ｓｗｉｎｇ）n",
