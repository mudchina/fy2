...
void create()
{
	set_name( "ÀäÇïÓê", ({ "qiu yu", "leng qiuyu" }) );
...
void greeting(object ob)
{
        ...
        switch( random(10) ) {
                case 0:
                        say( "ÀäÇïÓêĞ¦ßäßäµØÏòÄãÅ×ÁË¸öÃÄËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                                + "£¬¹ıÀ´£¬¹ıÀ´£¬æªÉíÅãÄú¶Ä¼¸ÊÖ£¡\n");
                        break;
                case 1:
                        say( "ÀäÇïÓê½«Ì¨ÉÏµÄ÷½ÅÆÇĞÁËÇĞµÀ£º" + RANK_D->query_respect(ob)
                                + "£¬¿´Äú½ñÌìÒ»¶¨»áÄÃµ½Ìì¶Ô¶ù£¡\n");
                        break;
                case 2:
                        say( "ÀäÇïÓêËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                                + "£¬±ğÅÂ£¡½øÀ´£¡ ²»»áÎÒ¿ÉÒÔ½ÌÄã£¡\n");
                        break;
        }
