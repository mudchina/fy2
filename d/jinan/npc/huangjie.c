...
void create()
{
	set_name( "»Æ½ã", ({ "huang jie", "leng huang jie" }) );
...
void greeting(object ob)
{
        ...
        switch( random(10) ) {
                case 0:
                        say( "»Æ½ãĞ¦ßäßäµØÏòÄãÅ×ÁË¸öÃÄËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                                + "£¬¹ıÀ´£¬¹ıÀ´£¬æªÉíÅãÄú¶Ä¼¸ÊÖ£¡\n");
                        break;
                case 1:
                        say( "»Æ½ã½«Ì¨ÉÏµÄ÷½ÅÆÇĞÁËÇĞµÀ£º" + RANK_D->query_respect(ob)
                                + "£¬¿´Äú½ñÌìÒ»¶¨»áÄÃµ½Ìì¶Ô¶ù£¡\n");
                        break;
                case 2:
                        say( "»Æ½ãËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                                + "£¬±ğÅÂ£¡½øÀ´£¡ ²»»áÎÒ¿ÉÒÔ½ÌÄã£¡\n");
                        break;
        }
