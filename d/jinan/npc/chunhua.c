...
void create()
{
	set_name( "Àä´º»¨", ({ "chun hua", "leng chunhua" }) );
...
void greeting(object ob)
{
        ...
        switch( random(10) ) {
                case 0:
                        say( "Àä´º»¨Ğ¦ßäßäµØÏòÄãÅ×ÁË¸öÃÄËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                                + "£¬¹ıÀ´£¬¹ıÀ´£¬æªÉíÅãÄú¶Ä¼¸ÊÖ£¡\n");
                        break;
                case 1:
                        say( "Àä´º»¨½«Ì¨ÉÏµÄ÷½ÅÆÇĞÁËÇĞµÀ£º" + RANK_D->query_respect(ob)
                                + "£¬¿´Äú½ñÌìÒ»¶¨»áÄÃµ½Ìì¶Ô¶ù£¡\n");
                        break;
                case 2:
                        say( "Àä´º»¨ËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                                + "£¬±ğÅÂ£¡½øÀ´£¡ ²»»áÎÒ¿ÉÒÔ½ÌÄã£¡\n");
                        break;
        }
