...
void create()
{
	set_name( "ÀäÏÄÀö", ({ "xia li", "leng xiali" }) );
...
void greeting(object ob)
{
        ...
        switch( random(10) ) {
                case 0:
                        say( "ÀäÏÄÀöĞ¦ßäßäµØÏòÄãÅ×ÁË¸öÃÄËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                                + "£¬¹ıÀ´£¬¹ıÀ´£¬æªÉíÅãÄú¶Ä¼¸ÊÖ£¡\n");
                        break;
                case 1:
                        say( "ÀäÏÄÀö½«Ì¨ÉÏµÄ÷½ÅÆÇĞÁËÇĞµÀ£º" + RANK_D->query_respect(ob)
                                + "£¬¿´Äú½ñÌìÒ»¶¨»áÄÃµ½Ìì¶Ô¶ù£¡\n");
                        break;
                case 2:
                        say( "ÀäÏÄÀöËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                                + "£¬±ğÅÂ£¡½øÀ´£¡ ²»»áÎÒ¿ÉÒÔ½ÌÄã£¡\n");
                        break;
        }
